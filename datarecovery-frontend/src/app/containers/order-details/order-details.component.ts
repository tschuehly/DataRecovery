            ...
            <div class="col-span-2" *ngIf="edit">
              ...
              <div *ngIf="!edit" class="col-span-2 text-center mt-6">
                ...
                <div class="mt-4" [ngSwitch]="order.trackingState">
                  <p *ngSwitchCase="orderState.firstAnalysis">
                  ...
                  <p *ngSwitchCase="orderState.orderedFirstPartDispender">
                  ...
                  <p *ngSwitchCase="orderState.orderedSecondPartDispender">
                  ...
                  <p *ngSwitchCase="orderState.orderedThirdPartDispender">
                    Der vorherige Teilespender war entweder nicht kompatibel oder nahm zu schnell neuen Schaden.<br/>
                    Es wird nun mit einem dritten Teilespender der letzte Versuch gestartet.<br/>
                  </p>
                  <p *ngSwitchCase="orderState.readingMemory">
              ...
              <ng-container *ngIf="edit">
                  <div class="col-span-2 text-center mt-6">
                      <select [formControl]="orderTrackingState">
                          <option *ngFor="let state of orderState | keyvalue"
                                  [ngValue]="state.value">{{state.value}}</option>
                      </select>
                  </div>
...
export class OrderDetailsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.order.completionDate){
      this.daysToCompletion = new Date(this.order.completionDate).getDate() - new Date().getDate();
    }
