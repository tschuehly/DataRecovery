    ...
    <div class="container sm:px-10 my-10">
      <div>
        ...
        <p><span style="text-decoration:underline"><span style="font-weight:bold">Externe Links</span></span><br>
          ...
          übernehmen.<br>
          Für die Inhalte und Richtigkeit der bereitgestellten Informationen ist der jeweilige Anbieter der verlinkten
        ...
        <p>Die Verarbeitung personenbezogener Daten, beispielsweise des Namens,
          ...
          und Zweck der von uns erhobenen, genutzten und verarbeiteten personenbezogenen Daten informieren. Ferner
        ...
        <p>Mittels eines Cookies können die Informationen und Angebote auf unserer
          ...
          beispielsweise nicht bei jedem Besuch der Internetseite erneut seine Zugangsdaten eingeben, weil dies von der
        ...
        <p>Die Internetseite unseres Unternehmens erfasst mit jedem Aufruf der
          ...
          verwendete Betriebssystem, (3) die Internetseite, von welcher ein zugreifendes System auf unsere Internetseite
        ...
        <p>Bei der Nutzung dieser allgemeinen Daten und Informationen ziehen wir
          ...
          und Informationen werden durch uns daher einerseits statistisch und ferner mit dem Ziel ausgewertet, den
          Datenschutz und die Datensicherheit in unserem Gewerbe zu erhöhen, um letztlich ein optimales Schutzniveau für
        ...
        <p>Die Internetseite <span style="font-style:italic">datenrettung-schilling.de</span>
          ...
          ein Kontaktformular den Kontakt mit dem für die Verarbeitung Verantwortlichen aufnimmt, werden die von der
        ...
        <ul>
          ...
          <li>
            ...
            <p>Jede von der Verarbeitung personenbezogener Daten betroffene Person
              ...
              Verfahren erfolgt, sofern die Verarbeitung nicht für die Wahrnehmung einer Aufgabe erforderlich ist, die
          ...
          <li>
            ...
            <p>Jede von der Verarbeitung personenbezogener Daten betroffene Person
              ...
              Rechtsvorschriften der Union oder der Mitgliedstaaten, denen der Verantwortliche unterliegt, zulässig ist
              und diese Rechtsvorschriften angemessene Maßnahmen zur Wahrung der Rechte und Freiheiten sowie der
        ...
        <p>Google Analytics setzt ein Cookie auf dem informationstechnologischen
          ...
          zum Zwecke der Online-Analyse an Google zu übermitteln. Im Rahmen dieses technischen Verfahrens erhält Google
          Kenntnis über personenbezogene Daten, wie der IP-Adresse der betroffenen Person, die Google unter anderem dazu
        ...
        <p>Ferner besteht für die betroffene Person die Möglichkeit, einer
          ...
          <a data-auto-recognition="true" href="https://tools.google.com/dlpage/gaoptout"
          ...
          Daten und Informationen zu den Besuchen von Internetseiten an Google Analytics übermittelt werden dürfen. Die
          Installation des Browser-Add-Ons wird von Google als Widerspruch gewertet. Wird das informationstechnologische
          System der betroffenen Person zu einem späteren Zeitpunkt gelöscht, formatiert oder neu installiert, muss
          durch die betroffene Person eine erneute Installation des Browser-Add-Ons erfolgen, um Google Analytics zu
          deaktivieren. Sofern das Browser-Add-On durch die betroffene Person oder einer anderen Person, die ihrem
          Machtbereich zuzurechnen ist, deinstalliert oder deaktiviert wird, besteht die Möglichkeit der Neuinstallation
        ...
        <p>Weitere Informationen und die geltenden Datenschutzbestimmungen von
          ...
          und unter
          <a data-auto-recognition="true" href="http://www.google.com/analytics/terms/de.html"
                                target="_blank">http://www.google.com/analytics/terms/de.html</a>
          abgerufen werden. Google Analytics wird unter diesem Link
          <a data-auto-recognition="true" href="https://www.google.com/intl/de_de/analytics/"
                                target="_blank">https://www.google.com/intl/de_de/analytics/</a>
          genauer erläutert.
        </p>
        ...
        <p>Art. 6 I lit. a DS-GVO dient uns als Rechtsgrundlage für
          ...
          Dann würde die Verarbeitung auf Art. 6 I lit. d DS-GVO beruhen. Letztlich könnten Verarbeitungsvorgänge auf
          Art. 6 I lit. f DS-GVO beruhen. Auf dieser Rechtsgrundlage basieren Verarbeitungsvorgänge, die von keiner der
          vorgenannten Rechtsgrundlagen erfasst werden, wenn die Verarbeitung zur Wahrung eines berechtigten Interesses
          unseres Gewerbes oder eines Dritten erforderlich ist, sofern die Interessen, Grundrechte und Grundfreiheiten
          des Betroffenen nicht überwiegen. Solche Verarbeitungsvorgänge sind uns insbesondere deshalb gestattet, weil
          sie durch den Europäischen Gesetzgeber besonders erwähnt wurden. Er vertrat insoweit die Auffassung, dass ein
        ...
        <p>Wir klären Sie darüber auf, dass die Bereitstellung personenbezogener
          ...
          Folge durch uns verarbeitet werden müssen. Die betroffene Person ist beispielsweise verpflichtet uns
          personenbezogene Daten bereitzustellen, wenn wir mit ihr einen Vertrag abschließen. Eine Nichtbereitstellung
          der personenbezogenen Daten hätte zur Folge, dass der Vertrag mit dem Betroffenen nicht geschlossen werden
          könnte. Vor einer Bereitstellung personenbezogener Daten durch den Betroffenen muss sich der Betroffene an uns
          wenden. Ich kläre den Betroffenen einzelfallbezogen darüber auf, ob die Bereitstellung der personenbezogenen
          Daten gesetzlich oder vertraglich vorgeschrieben oder für den Vertragsabschluss erforderlich ist, ob eine
        ...
        <p>Diese Datenschutzerklärung wurde durch den
          Datenschutzerklärungs-Generator der DGD Deutsche Gesellschaft für Datenschutz GmbH, die als <span
            ...
            target="_blank" rel="noopener">Externer Datenschutzbeauftragter Hamburg</a></span> tätig ist, in Kooperation
          mit dem <span style="text-decoration:underline"><a href="https://www.wbs-law.de/" target="_blank"
