      ...
      <div class="flex flex-col gap-2 text-base md:text-lg">
        <ng-container *ngIf="!productFormFilled">
          <label class="py-4 px-12"
            ...
            <div class="text-sm md:text-base">Bereits inkl. 19% Mehrwertsteuer.</div>
          </label>
          ...
          <ng-container *ngIf="productSelect.value">
            ...
            <label class="py-4 px-12"
              ...
              <select
                ...
                required
              >
                <option selected value="1">Auf Rechnung,  14 Tage Zahlungsfrist nach Abschluss der Datenrettung</option>
              </select>
            </label>
          </ng-container>
