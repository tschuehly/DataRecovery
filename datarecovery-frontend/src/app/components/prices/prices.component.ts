  ...
  template: `
    ...
    <div class="bg-gray-main  ">
      <div class="container flex ">
        ...
        <p>Wenn Sie sich nicht sicher über Ihren Schaden sind, rufen Sie mich gerne unter <a href="tel:0841 12840705">0841 12840705</a> an oder wählen Sie zunächst "Standard" aus. </p>
        </div>
      </div>
    </div>
    <div class="grid grid-cols-1 xl:grid-cols-2  border-b-2 border-t-2">
      <div class="text-white text-base md:text-lg">
        ...
        >
          ...
          <br />Bei Misserfolg: Bearbeitung inkl. Rückversand des Originalspeichers vollständig kostenfrei.<br/>
        </div>
      </div>
