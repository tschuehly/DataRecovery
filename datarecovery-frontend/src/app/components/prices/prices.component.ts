  ...
  template: `
    ...
    <div class="bg-gray-main  ">
      <div class="container flex ">
        ...
        <p>Wie wir uns von unseren Mitbewerbern unterscheiden erfahren Sie hier: <a routerLink="/blog/datenrettung-kosten" class="underline">Kostenvorteil gegenüber Mitbewerbern</a>. </p>
        </div>
      </div>
    </div>
