  ...
  template: `
    ...
    <div class="bg-gray-main  ">
      <div class="container flex ">
        ...
        >
        <p>Was uns von unserer Konkurrenz unterscheidet erfahren Sie hier: <a routerLink="/blog/datenrettung-kosten" class="underline">Vorteile gegenüber Mitbewerber</a>. </p>
