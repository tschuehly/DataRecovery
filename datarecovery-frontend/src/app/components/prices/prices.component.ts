  ...
  template: `
    ...
    <div class="bg-gray-main  ">
      <div class="container flex ">
        ...
        <p>Welche Schäden als "einfache Fälle" gelten finden Sie hier: <a routerLink="/blog/was-zählt-als-einfacher-fall" class="underline">Unterteilung der Schäden</a>.</p>
