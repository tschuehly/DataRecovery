  ...
  template: `
    ...
    <div class="bg-gray-main  ">
      <div class="container flex ">
        ...
        <p>Wie sich das Angebot gegenüber Mitbewerber unterscheidet erfahren Sie hier: <a routerLink="/blog/datenrettung-kosten" class="underline">Kostenvorteil gegenüber Mitbewerber</a>. </p>
        </div>
      </div>
    </div>
