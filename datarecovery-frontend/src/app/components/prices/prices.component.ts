  ...
  template: `
    ...
    <div class="bg-gray-main  ">
      <div class="container flex ">
        ...
        <p>Wie sich mein Angebot von den Mitbewerbern unterscheiden erfahren Sie hier: <a routerLink="/blog/datenrettung-kosten" class="underline">Kostenvorteil gegenüber Mitbewerbern</a>. </p>
        </div>
      </div>
    </div>
