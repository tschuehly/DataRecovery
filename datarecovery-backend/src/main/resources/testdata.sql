...
INSERT INTO public.order_table (id, order_date, replacement, tracking_id, tracking_state, customer_id, order_product_id,monthly_payment) VALUES (7, '2021-05-25 09:35:46.122', 'Sie senden einen eigenen Ersatzspeicher zur Sicherung mit: kostenfrei', '2455f26a-a110-4c7d-a907-6873585f0a5b', 'Auftrag eingegangen', 8, 5,2);
INSERT INTO public.order_table (id, order_date, replacement, tracking_id, tracking_state, customer_id, order_product_id,monthly_payment) VALUES (29, '2021-05-25 13:17:46.251', 'SanDisk Cruzer USB-Stick 64GB : 15€', '0fd9d5fc-c6bb-40b2-9118-3989e1dd51dc', 'Auftrag eingegangen', 30, 11,1);
INSERT INTO public.order_table (id, order_date, replacement, tracking_id, tracking_state, customer_id, order_product_id,monthly_payment) VALUES (31, '2021-05-25 14:08:54.861', 'WD Portable (externe Festplatte) 500GB : 50€', '9d89e2a8-d2a3-47d5-ac39-789b2c34064c', 'Auftrag eingegangen', 32, 5,2);
INSERT INTO public.order_table (id, order_date, replacement, tracking_id, tracking_state, customer_id, order_product_id,monthly_payment) VALUES (52, '2021-05-27 20:01:10.675', 'Sicherung auf WD Elements Portable externe Festplatte 500GB: 50,00 EUR', '7fb274bc-f00e-4a97-9496-cd41d399e271', 'Auftrag eingegangen', 53, 5,1);
