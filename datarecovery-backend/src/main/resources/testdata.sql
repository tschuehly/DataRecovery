...
INSERT INTO order_table (id, order_date, replacement, tracking_id, tracking_state, customer_id, product_id) VALUES (1, '2021-05-25 13:17:46.251', 'SanDisk Cruzer USB-Stick 64GB : 15€', '0fd9d5fc-c6bb-40b2-9118-3989e1dd51dc', 'Auftrag eingegangen', 30, 14);
...
insert into order_table (id, order_date, replacement, tracking_id, tracking_state, customer_id, product_id) values (5, '2017-01-15', 'SanDisk Cruzer USB-Stick 64GB : 15€', 'ef8a06aa-856b-4c51-959f-338805e38aec', 'Auftrag eingegangen', 2, 19);
...
insert into order_table (id, order_date, replacement, tracking_id, tracking_state, customer_id, product_id) values (7, '2019-07-12', 'SanDisk Cruzer USB-Stick 64GB : 15€', 'd0581b64-7e76-41ed-a30c-15b51eb87a61', 'Auftrag eingegangen', 2, 20);
...
insert into order_table (id, order_date, replacement, tracking_id, tracking_state, customer_id, product_id) values (12, '2018-02-18', 'SanDisk Cruzer USB-Stick 64GB : 15€', '8ca556c8-83e0-4635-bcce-4ed794e40b9c', 'Auftrag eingegangen', 2, 15);
...
insert into order_table (id, order_date, replacement, tracking_id, tracking_state, customer_id, product_id) values (14, '2017-07-09', 'SanDisk Cruzer USB-Stick 64GB : 15€', 'd7dcf053-5722-49b0-9df3-b89c129edf3c', 'Auftrag eingegangen', 2, 16);
